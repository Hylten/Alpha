...
export const AlphaIntelligenceArticle: React.FC<AlphaIntelligenceArticleProps> = ({ slug }) => {
    ...
    return (
        <article className="pt-32 pb-24 px-6 md:px-12 max-w-3xl mx-auto min-h-screen relative z-10">
            ...
            {/* Back to Intelligence + Prev/Next Navigation */}
            ...
            <div className="mt-16 flex justify-center">
                <div className="relative">
                    <button
                        onClick={() => {
                            const popup = document.getElementById('alpha-share-popup');
                    ...
                    <div id="alpha-share-popup" style={{ display: 'none' }} className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-3 bg-obsidian border border-white/10 px-4 py-3 rounded-2xl shadow-xl">
