...
async function generateSEO() {
    ...
    const sharedButtons = `
        ...
        <a href="https://wa.me/46701619978?text=Regarding%20Roials%20Alpha:" target="_blank" rel="noopener noreferrer" style="position: fixed; bottom: 32px; right: 32px; z-index: 10000; background: #25D366; padding: 16px; border-radius: 50%; box-shadow: 0 10px 30px rgba(0,0,0,0.5); transition: transform 0.3s; display: flex; align-items: center; justify-content: center;">
